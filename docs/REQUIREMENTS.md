...
I don't need an installation wizard - Codex CLI guides the setup. I don't need a monitoring dashboard - I ask Codex CLI what's happening. I don't need elaborate logging UIs - I ask Codex to read the logs. I don't need debugging tools - I describe the problem and Codex fixes it.
...
- Use existing tools (WhatsApp connector, Codex CLI, MCP servers)
- Minimal glue code
- File-based systems where possible (CODEX.md for memory, folders for groups)
...
### Memory System
- **Per-group memory**: Each group has a folder with its own `CODEX.md`
- **Global memory**: Root `CODEX.md` is read by all groups, but only writable from "main" (self-chat)
- **Files**: Groups can create/read files in their folder and reference them
- Agent runs in the group's folder, automatically inherits both CODEX.md files

### Session Management
- Each group maintains a conversation session (via Codex CLI)
...
- Can write to global memory (`groups/CODEX.md`)
